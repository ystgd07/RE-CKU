                                            ...
                                            <dl>
                                                <dt>
                                                    ...
                                                    <label className="switch">
                                                        <input type="checkbox" checked={toggle ? true : false} onChange={():void => setToggle(!toggle)}/>
                                                        <span className="slider"></span>
                                                    </label>
                                                </dt>
                                                
                                                <dd><DatePicker placeholder="YYYY-MM" picker="month" onChange={(date, dateString):void => console.log("asd",dateString)}/></dd>
                                            </dl>
                                            {toggle&&
                                                <dl>
                                                    <dt>퇴사</dt>
                                                    <dd><DatePicker placeholder="YYYY-MM" picker="month" /></dd>
                                                </dl>
                                            }
